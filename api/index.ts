...
const contentByTab: Record<string, ContentResponse> = {
  dashboard: {
    ...
    content:
      "Welcome to your NoPaymentsGateway.xyz dashboard. Here you can monitor your transaction volume, manage your active products, and view real-time payment analytics.",
  },
  create: {
  ...
  docs: {
    ...
    content:
      "Comprehensive documentation for integrating NoPaymentsGateway.xyz into your existing workflows using our lightweight JS SDK and REST APIs.",
  },
  profile: {
  ...
  contact: {
    title: "Contact Us",
    content:
      "Get in touch with our team for any inquiries. Email us at support@nopaymentsgateway.xyz or call us at 1-800-NOPAYMENT. Our support hours are Monday to Friday, 9 AM to 6 PM EST.",
  },
  terms: {
    title: "Terms and Conditions",
    content:
      "By using NoPaymentsGateway.xyz, you agree to our terms of service. You must be at least 18 years old to use our platform. We reserve the right to suspend accounts that violate our acceptable use policy, including processing payments for prohibited goods.",
  },
  privacy: {
